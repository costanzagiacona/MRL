...
for i = heightGrid:-1:2 % Scorriamo tutta l'altezza della griglia dall'alto verso il basso
    if (i > round(heightGrid/1.2)) % Se siamo nella parte superiore della griglia
        for j = 10:lengthGrid-30 % Definiamo una sezione della strada
        ...
        if (count_incr ==5) % ogni 5 passi, aumentiamo il valore con cui 
